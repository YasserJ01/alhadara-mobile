...
class InterestSelectionBloc
    extends Bloc<InterestSelectionEvent, InterestSelectionState> {
  final GetInterestsUseCase getInterestsUseCase;

  InterestSelectionBloc({required this.getInterestsUseCase})
      : super(InterestSelectionState.initial()) {
  ...
  void _onToggleInterestSelection(
    ...
    final newSelectedInterests =
        List<InterestEntity>.from(state.selectedInterests);
