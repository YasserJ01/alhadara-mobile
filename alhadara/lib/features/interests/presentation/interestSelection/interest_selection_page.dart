...
import 'package:alhadara/features/interests/presentation/interestSelection/widgets/interest_chip.dart';
import 'package:alhadara/features/interests/presentation/interest_rating/interest_rating_page.dart';
...
class InterestSelectionPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => getIt<InterestSelectionBloc>()..add(LoadInterests()),
