...
import 'package:alhadara/features/enrollments/presentation/widgets/payment_dialog.dart';
...
//   const EnrollmentCard({required this.enrollment});
...
//                   Expanded(
//                     child: Text(
//                       enrollment.courseTitle.toUpperCase(),
...
//               // Course Details
//               _buildInfoRow(Icons.school, 'Course', enrollment.courseTitle),
//               const SizedBox(height: 8),
//               _buildScheduleRow(enrollment.scheduleSlotDisplay),
//               const SizedBox(height: 8),
//               _buildInfoRow(Icons.person, 'Student', enrollment.studentName),
//               const SizedBox(height: 8),
//               _buildInfoRow(Icons.calendar_today, 'Enrolled on',
...
//               //   const Divider(height: 1),
//               //   const SizedBox(height: 8),
//               //   _buildNotesSection(enrollment.notes),
//               // ],
//             ],
//           ),
//         ),
...
//   Widget _buildScheduleRow(String schedule) {
//     return Row(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         Icon(Icons.schedule, size: 20, color: AppColors.mainColor),
//         const SizedBox(width: 8),
//         Expanded(
//           child: Column(
//             crossAxisAlignment: CrossAxisAlignment.start,
...
//   Widget _buildPaymentSummary(double paid, double balance, String status) {
//     return Row(
//       mainAxisAlignment: MainAxisAlignment.spaceBetween,
//       children: [
//         _buildPaymentItem('Paid', '\$${paid.toStringAsFixed(2)}', Colors.green),
//         _buildPaymentItem(
//             'Remaining', '\$${balance.toStringAsFixed(2)}', Colors.orange),
//         _buildPaymentStatus(status),
//       ],
//     );
//   }
