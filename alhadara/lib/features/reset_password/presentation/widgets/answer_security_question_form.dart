...
import 'package:alhadara/features/reset_password/presentation/pages/reset_password_page.dart';
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Answer the question to reset your password',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: AppSizes.responsiveFontSize(context,
                ...
                SizedBox(
                    height: AppSizes.responsiveSize(context,
                        ...
                        AppElevatedButton(
                          child: 
                            state is AnswerSecurityQuestionLoading
