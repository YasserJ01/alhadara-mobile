...
import 'package:alhadara/features/reset_password/presentation/widgets/answer_security_question_form.dart';
...
class AnswerSecurityQuestionPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: ResetPasswordScaffold(
        body: AnswerSecurityQuestionForm(
